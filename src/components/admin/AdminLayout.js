...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-umi-bg flex">
      {/* SIDEBAR */}
      <aside className="w-64 bg-umi-sidebar border-r border-umi-border flex flex-col flex-shrink-0 fixed h-full">
        <div className="p-5 border-b border-umi-border">
